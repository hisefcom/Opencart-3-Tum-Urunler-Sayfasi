...
class ControllerProductLatest extends Controller {
	public function index() {
		...
		$product_total = $this->model_catalog_latest->getLatestTotal();

		$results = $this->model_catalog_latest->getLatestProducts($filter_data);
		...
		if ($page == 1) {
		    ...
		    $this->document->addLink($this->url->link('product/latest', 'page='. $page , true), 'canonical');
		}		
